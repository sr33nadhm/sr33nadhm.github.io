    ...
    return (
        <section className="section-col py-5">
            ...
            <div className="social-media">
                ...
                <a href="tel:+919645243474" style={{ color: 'inherit' }}>
                    <IconButton color="inherit" aria-label="upload picture" component="label" className="hover-highlight" rel="noreferrer" target='_blank'>
                ...
                <a href="https://api.whatsapp.com/send?phone=919645243474&text=Hi,%20I%20saw%20your%20profile%20and%20I'd%20like%20to%20connect!" style={{ color: 'inherit' }}>
                    <IconButton color="inherit" aria-label="upload picture" component="label" className="hover-highlight" rel="noreferrer" target='_blank'>
